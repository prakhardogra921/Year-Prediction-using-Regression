...
if __name__ == "__main__":
    ...
    for _ in range(5):
        print("Training for Lambda", pr.l1_lambda)
        b = np.random.normal()
        ...
        W = np.random.normal(scale=1 / X_t.shape[1] ** .5, size=temp.shape[1])
    ...
    print("With best hyperparameter lambda ", pr.l1_lambda)
    ...
    np.save("PLRWeights", np.append(W, b))
